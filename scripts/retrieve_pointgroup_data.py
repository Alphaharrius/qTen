    ...
    PROVENANCE_PATH.write_text(
        "\n".join(
            [
                ...
                "",
                "spgrep enumerates projective spinor irreducible representations and",
                "factor systems. The generator converts its SU(2) section to QTen's",
                "`qten-su2-principal-v1` convention and stores operation-wise characters.",
                "No Bilbao double-group tables or labels are copied into this cache.",
                "",
                "spgrep is a build-time development dependency only. Runtime table lookup",
                "does not import spgrep. The cache records the spgrep version, source-data",
                "SHA-256, generator SHA-256 values, factor systems, and character rounding",
                "precision so regeneration can be checked deterministically.",
                "",
            ]
        ),
        encoding="utf-8",
