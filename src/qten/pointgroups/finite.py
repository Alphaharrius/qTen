...
class FinitePointGroup:
    ...
    \]
    [`irrep_projector`][qten.pointgroups.finite.FinitePointGroup.irrep_projector]
    ...
    ([`spinor_irrep_characters_by_element`][qten.pointgroups.finite.FinitePointGroup.spinor_irrep_characters_by_element]).
